        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="py-20 md:py-28 lg:py-32 max-w-3xl">
            ...
            <p className="mt-6 text-xl text-gray-100">
              Specialized Application Delivery Controller solutions with expert implementation,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Comprehensive F5 BIG-IP solutions to optimize your application delivery and security
              infrastructure.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
              ...
              <p className="text-gray-600 mb-4">
                Advanced load balancing solutions using F5 BIG-IP LTM for optimal application
            ...
            <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
              ...
              <p className="text-gray-600 mb-4">
                Comprehensive security solutions using F5 BIG-IP ASM and Advanced WAF to protect
                your applications.
              </p>
              <ul className="text-gray-600 text-sm space-y-2">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
              ...
              <p className="text-gray-600 mb-4">
                Intelligent DNS and global load balancing solutions using F5 BIG-IP GTM for
                worldwide application delivery.
              </p>
              <ul className="text-gray-600 text-sm space-y-2">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
              ...
              <p className="text-gray-600 mb-4">
                Advanced performance optimization using F5 BIG-IP features to enhance application
            ...
            <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
              ...
              <p className="text-gray-600 mb-4">
                Seamless integration of F5 BIG-IP with cloud platforms for hybrid and multi-cloud
            ...
            <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
              ...
              <p className="text-gray-600 mb-4">
                Ongoing management, monitoring, and support services to ensure optimal F5 BIG-IP
      ...
      <div className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our certified engineers have deep expertise across the entire F5 BIG-IP product
              portfolio.
            </p>
          </div>
      ...
      <div className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our proven methodology ensures successful F5 BIG-IP deployments with minimal
              disruption.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Comprehensive analysis of current infrastructure and application requirements to
                design optimal F5 solutions.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Custom F5 BIG-IP architecture design that aligns with your business objectives and
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Expert deployment and configuration with zero-downtime migration and comprehensive
                testing.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Ongoing monitoring, tuning, and optimization to ensure peak performance and maximum
                ROI.
              </p>
            </div>
          </div>
      ...
      {/* <div className="py-20 bg-gradient-to-r from-blue-800 to-blue-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="text-blue-200 text-sm font-medium mb-2">F5 ADC CASE STUDY</div>
              <h2 className="text-3xl font-bold mb-6">
                E-commerce Platform F5 BIG-IP Implementation
              </h2>
              <p className="text-blue-100 mb-8">
                We implemented F5 BIG-IP LTM and ASM for a major e-commerce platform, resulting in
                50% improved performance and 99.99% uptime during peak shopping seasons.
              </p>
      ...
      <div className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our team holds multiple F5 certifications ensuring you get expert-level service and
              support.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gray-50 p-8 rounded-lg text-center">
              ...
              <p className="text-gray-600">F5 Certified Administrator - BIG-IP</p>
            </div>
            ...
            <div className="bg-gray-50 p-8 rounded-lg text-center">
              ...
              <p className="text-gray-600">F5 Certified Solution Expert - BIG-IP</p>
            </div>
            ...
            <div className="bg-gray-50 p-8 rounded-lg text-center">
              ...
              <p className="text-gray-600">F5 Certified Security Professional</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-gray-300 text-lg mb-8 max-w-3xl mx-auto">
              Let our F5 experts help you maximize the performance, security, and availability of
              your applications.
            </p>
